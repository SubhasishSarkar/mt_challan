...
function RungtaChallan() {
    return (
        <div className="rungta-challan">
            <div className="conatiner p-5">
                <div className="border-2 border-black p-5">
                    ...
                    <div className="form_wrapper">
                        <div className="date_wrapper flex justify-between flex-wrap">
                            <div>No-</div>
                            <div>
                                <label>Date : </label>
                        ...
                        <div>
                            <div className="flex flex-wrap">
                                <div className="flex-1 flex">
                                    <label>M/s : </label>
                                    <input className="flex-1 ml-1" type="text" />
                                </div>
                                <div className="flex-1 flex">
                                    <label> Truck No. : </label>
                                    <input className="flex-1 ml-1" type="text" style={{ textTransform: "uppercase" }} />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap">
                                ...
                                <div className="flex-1 flex">
                                    ...
                                    <input type="text" className="flex-1 ˇ" />
                                </div>
                            </div>
